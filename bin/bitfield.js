...
var argv = yargs
  ...
  .option('hflip', {describe: 'horizontal flip', boolean: true, default: false})
  .option('vflip', {describe: 'vertical flip', boolean: true, default: false})
  .option('compact', {describe: 'compact format', boolean: true, default: false})
